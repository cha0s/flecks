...
:::tip[Really, a command just to add a fleck?]

<Install headless pkg="@flecks/web">
  Yep! This is only for your convenience however, as it is equivalent to doing:
</Install>
...
to your `build/flecks.yml`; that's all it does!
...
<Execute cmd="flecks add -d @flecks/electron">
