...
Notice there's a colon separating the path for this one. This is because this is an aliased fleck.
...
Next, we'll go over some of the nuts and bolts of how your flecks are compiled.
