...
Who cares about exporting, though? I created a fleck and everything Just Works™. This
...
<Run cmd="test">
  If you run **from your `packages/example` directory**:
</Run>

You will see that only one test was run:
