...
path!** This means that **flecks will discover your `src` directory** and use it when compiling
your application.

:::tip[Link 'em up]

When you are rapidly developing anything Sufficiently Complex:tm:, **best practice is to symlink
