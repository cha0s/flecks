...
- 🧩 **Small but pluggable**
  ...
  - Endlessly configurable through built-in [hooks](./docs/flecks/hooks) and then your own
- 🛠️ **Ready to build maintainable and performant production applications**
  - [Documentation](./docs/documentation) generation for your project with no fuss
  - [Write tests](./docs/building-your-fleck#testing), run on server/in browser/...
  - [React](./docs/react) / [redux](./docs/redux)
  - [Realtime sockets](./docs/sockets) with lots of goodies like binary packing and packet dispatching
  - [Databases](./docs/database) using [Sequelize](https://sequelize.org/) to connect and [Docker](https://www.docker.com/) to easily persist
...
- [reddit](https://www.reddit.com/r/flecks/)
- [X / Twitter](https://twitter.com/makeflecks)
