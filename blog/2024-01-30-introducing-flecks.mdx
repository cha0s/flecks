...
of thing, you might be interested in the <Link target="_blank" to="../docs/react">React</Link>
...
To put it in basic terms: A webserver is a core aspect of a fullstack application, but **a
webserver is not a core aspect of an application**. The same could be said about asset
...
The core concept is the concept of a **fleck** which is... just a JS module. There exists a server
...
<Link target="_blank" to="../docs/flecks/hooks">the hooks reference page</Link>.

You add a reference to your fleck to a file called
<Link target="_blank" to="../docs/creating-a-fleck">`flecks.yml`</Link> and you're rolling. Again,
...
its constituting elements: the implication is that **flecks is just flecks**, it's not doing
anything special on its own. Sure, it *does something*, but the something that it does is simply
orchestrate your flecks together into an application.
...
A few motivating philosophies which I **do not** consider to be suggestions when creating flecks:

- You shouldn't be surprised by what happens
...
<figure>
  ...
  <figcaption style={{fontSize: '0.8rem'}}>*You've never even **seen** a real <Link target="_blank" to="../docs/redux">duck</Link>*</figcaption>
</figure>


With flecks, the first-class motivation is to push these concerns out into modular units
which do one thing and do it immaculately.
...
I understand and appreciate the benefits of strong typing. I have also noticed that TS tends to sap
my joy when I work with it!

If you love flecks enough to be serious about working to improve it and you can also make a
compelling and transparent case to rewrite some or all of it in TS, I'm listening!

## Again, thanks for your time

I appreciate you reading all that! Come send me love (or threats or whatever) at the
