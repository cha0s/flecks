...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.1 to ^4.0.2
    * @flecks/redux bumped from ^4.0.1 to ^4.0.2
    * @flecks/session bumped from ^4.0.1 to ^4.0.2
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.3 to ^4.0.4
    * @flecks/redux bumped from ^4.0.3 to ^4.0.4
    * @flecks/session bumped from ^4.0.3 to ^4.0.4
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.4 to ^4.0.5
    * @flecks/redux bumped from ^4.0.4 to ^4.0.5
    * @flecks/session bumped from ^4.0.4 to ^4.0.5
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.5 to ^4.0.6
    * @flecks/redux bumped from ^4.0.5 to ^4.0.6
    * @flecks/session bumped from ^4.0.5 to ^4.0.6
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.6 to ^4.0.7
    * @flecks/redux bumped from ^4.0.6 to ^4.0.7
    * @flecks/session bumped from ^4.0.6 to ^4.0.7
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.7 to ^4.1.0
    * @flecks/redux bumped from ^4.0.7 to ^4.0.8
    * @flecks/session bumped from ^4.0.7 to ^4.0.8
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.1.0 to ^4.1.1
    * @flecks/redux bumped from ^4.0.8 to ^4.0.9
    * @flecks/session bumped from ^4.0.8 to ^4.0.9
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.1.1 to ^4.1.2
    * @flecks/redux bumped from ^4.0.9 to ^4.0.10
    * @flecks/session bumped from ^4.0.9 to ^4.0.10
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.1.2 to ^4.1.3
    * @flecks/redux bumped from ^4.0.10 to ^4.0.11
    * @flecks/session bumped from ^4.0.10 to ^4.0.11
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.1.3 to ^4.1.4
    * @flecks/redux bumped from ^4.0.11 to ^4.0.12
    * @flecks/session bumped from ^4.0.11 to ^4.0.12
  * devDependencies
    * @flecks/build bumped from ^4.1.3 to ^4.1.4
    * @flecks/fleck bumped from ^4.1.3 to ^4.1.4

## [4.0.3](https://github.com/cha0s/flecks/compare/passport-v4.0.2...passport-v4.0.3) (2024-02-09)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^4.0.2 to ^4.0.3
    * @flecks/redux bumped from ^4.0.2 to ^4.0.3
    * @flecks/session bumped from ^4.0.2 to ^4.0.3
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @flecks/db bumped from ^3.2.4 to ^4.0.0
    * @flecks/redux bumped from ^3.2.4 to ^4.0.0
    * @flecks/session bumped from ^3.2.4 to ^4.0.0
  * devDependencies
